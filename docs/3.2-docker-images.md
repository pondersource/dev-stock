...
| pondersource/nextcloud:v29.0.10        | Nextcloud v29.0.10             |
| pondersource/nextcloud:v30.0.2         | Nextcloud v30.0.2 (latest)     |
...
3. Contacts app:
    ...
    - pondersource/nextcloud:v29.0.10-contacts
    - pondersource/nextcloud:v30.0.2-contacts
