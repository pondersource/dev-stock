...
|---------------|-------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
| Login         | Tests basic authentication against an EFSS platform                     | `./dev/ocm-test-suite.sh login nextcloud v30.0.11 dev chrome`                                                 |
| Share-With    | Tests federated sharing between two EFSS platforms                      | `./dev/ocm-test-suite.sh share-with nextcloud v30.0.11 owncloud v10.x dev chrome`                             |
| Share-Link    | Tests sharing via public links between platforms                        | `./dev/ocm-test-suite.sh share-link nextcloud v30.0.11 owncloud v10.x dev chrome`                             |
| Invite-Link   | Tests invitation‑based sharing between platforms                        | `./dev/ocm-test-suite.sh invite-link nextcloud v30.0.11 owncloud v10.x dev chrome`                            |
