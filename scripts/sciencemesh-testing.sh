...
docker run --restart=always -d --network=testnet --name=${EFSS1}1.docker -v $REPO_ROOT/$EFSS1-sciencemesh:/var/www/html/apps/$EFSS1-sciencemesh  pondersource/dev-stock-${EFSS1}1-sciencemesh
...
docker run --restart=always -d --network=testnet --name=${EFSS2}2.docker -v $REPO_ROOT/$EFSS2-sciencemesh:/var/www/html/apps/$EFSS2-sciencemesh pondersource/dev-stock-${EFSS2}2-sciencemesh
