...
sed -i "43 i\  'filelocking.enabled' => true,"                          /var/www/html/config/config.php
sed -i "44 i\  'memcache.locking' => '\\OC\\Memcache\\Redis',"          /var/www/html/config/config.php
sed -i "45 i\  'memcache.local' => '\\OC\\Memcache\\Redis',"            /var/www/html/config/config.php
sed -i "46 i\  'memcache.distributed' => '\\OC\\Memcache\\Redis',"      /var/www/html/config/config.php
sed -i "47 i\  'redis' => ["                                            /var/www/html/config/config.php
sed -i "48 i\      'host' => '${REDIS_HOST}',"                          /var/www/html/config/config.php
sed -i "49 i\      'port' => 6379,"                                     /var/www/html/config/config.php
sed -i "50 i\      'timeout' => 0,"                                     /var/www/html/config/config.php
sed -i "51 i\      'password' => '',"                                   /var/www/html/config/config.php
