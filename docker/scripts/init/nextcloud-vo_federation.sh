...
# ------------------------------------------------------------------------------
# Nextcloud VO Federation App Initialization Script
# Author: Mohammad Mahdi Baghbani Pourvahid <mahdi@pondersource.com>
# ------------------------------------------------------------------------------
#
# Description:
#   This script initializes the Nextcloud VO Federation app in a Docker container.
...
#   2. Enables the VO Federation app using Nextcloud console
#
# Environment:
...
# Path configuration
readonly APP_SOURCE="/ponder/apps/vo_federation"        # Source directory containing the app
readonly APP_TARGET="/var/www/html/apps/vo_federation"  # Target directory in Nextcloud
...
# ------------------------------------------------------------------------------
setup_symlink() {
    log_message "INFO" "Setting up VO Federation app symlink..."
...
# ------------------------------------------------------------------------------
# Function: enable_app
# Purpose: Enables the VO Federation app in Nextcloud
#
# Returns:
...
# ------------------------------------------------------------------------------
enable_app() {
    log_message "INFO" "Enabling VO Federation app..."

    if ! php "${CONSOLE_PATH}" app:enable vo_federation; then
        log_message "ERROR" "Failed to enable VO Federation app"
        return 1
    fi

    log_message "INFO" "VO Federation app enabled successfully"
    return 0
}
...
# ------------------------------------------------------------------------------
main() {
    log_message "INFO" "Starting VO Federation app initialization..."
    ...
    log_message "INFO" "VO Federation app initialization completed successfully"
    exit 0
}
