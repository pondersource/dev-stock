# START https://github.com/SURFnet/rd-sram-integration/issues/240
...
ARG REPO_OWNCLOUD=https://github.com/pondersource/core
ARG BRANCH_OWNCLOUD=fixing_issue_240
...
# END https://github.com/SURFnet/rd-sram-integration/issues/240
