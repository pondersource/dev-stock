 ...
 */
export function ensureFileExistsV29(fileName, timeout = 10000) {
 ...
 */
export function acceptShareV29() {
 ...
 */
export function createAndSendShareLinkV29(fileName, recipientUsername, recipientDomain) {
  return createShareLinkV29(fileName).then((shareLink) => {
    cy.visit(shareLink);
 ...
 */
export function handleShareAcceptanceV29(fileName, timeout = 10000, appId = 'files', depth = 0, maxDepth = 5) {
  ...
  cy.get('body', { timeout: 10000 }).then($body => {
    ...
    if (hasDialog) {
      ...
      cy.reload(true).then(() => {
        ...
        handleShareAcceptanceV29(fileName, timeout, appId, depth + 1, maxDepth);
      });
    } else {
      ...
      // navigationSwitchLeftSideV29('Open navigation');
      // selectAppFromLeftSideV29(appId);
      // navigationSwitchLeftSideV29('Close navigation');

      // Verify the shared file exists with specified timeout
      ensureFileExistsV29(fileName, timeout);
    }
  });
}
 ...
 */
export function createShareV29(fileName, username, domain) {
  // Open the sharing panel for the specified file
  openSharingPanelV29(fileName);
 ...
 */
export function createShareLinkV29(fileName) {
  // Open the sharing panel for the specified file
  openSharingPanelV29(fileName);
 ...
 */
export function updateShareV29(fileName, index) {
  // Open the sharing panel for the specified file
  openSharingPanelV29(fileName);
 ...
 */
export function openSharingPanelV29(fileName) {
  // Trigger the "Details" action to open the sidebar
  triggerActionForFileV29(fileName, 'details');
 ...
 */
export function triggerActionForFileV29(filename, actionId) {
  // Open the file's action menu
  getActionButtonForFileV29(filename)
    .should('be.visible')
    .click({ force: true });
 ...
 */
export function getActionButtonForFileV29(filename) {
  return getActionsForFileV29(filename)
 ...
 */
export function getActionsForFileV29(filename) {
  return getRowForFileV29(filename)
 ...
 */
export function getRowForFileV29(filename) {
