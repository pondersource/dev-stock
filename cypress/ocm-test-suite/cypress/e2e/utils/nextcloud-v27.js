 ...
 */
export function handleShareAcceptanceV27(fileName, timeout = 10000, appId = 'files', depth = 0, maxDepth = 5) {
  ...
  cy.get('body', { timeout: 10000 }).then($body => {
    ...
    if (hasDialog) {
      ...
      cy.reload(true).then(() => {
        ...
        handleShareAcceptanceV27(fileName, timeout, appId, depth + 1, maxDepth);
      });
    } else {
