/**
 * @fileoverview
 * Cypress test suite for testing native federated sharing functionality in ownCloud v10 and Nextcloud v29.
...
describe('OCM federated sharing functionality for ownCloud', () => {
   ...
   */
  it('Send a federated share of a file from ownCloud v10 to Nextcloudn v29', () => {
   ...
   */
  it('Receive federated share of a file from ownCloud v10 to Nextcloud v29', () => {
