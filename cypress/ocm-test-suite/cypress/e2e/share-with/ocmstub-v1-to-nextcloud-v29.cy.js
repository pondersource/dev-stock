/**
 * @fileoverview
 * Cypress test suite for testing native federated sharing functionality in OcmStub v1 and Nextcloud v29.
...
describe('Federated sharing functionality from OcmStub to Nextcloud', () => {
   ...
   */
  it('should successfully send a federated share of a file from OcmStub v1 to Nextcloud v29', () => {
   ...
   */
  it('Receive federated share of a file from OcmStub v1 to Nextcloud v29', () => {
