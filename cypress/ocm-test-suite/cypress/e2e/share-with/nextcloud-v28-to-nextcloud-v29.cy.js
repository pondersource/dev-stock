/**
 * @fileoverview
 * Cypress test suite for testing native federated sharing functionality in Nextcloud v28 and v29.
...
describe('Native Federated Sharing Functionality for Nextcloud', () => {
   ...
   */
  it('Receive federated share of a file from Nextcloud v28 to Nextcloud v29', () => {
