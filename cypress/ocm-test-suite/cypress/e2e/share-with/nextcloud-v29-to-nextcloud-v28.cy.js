/**
 * @fileoverview
 * Cypress test suite for testing native federated sharing functionality in Nextcloud v29 and v28.
...
import {
  acceptShareV28,
  ensureFileExistsV28,
  navigationSwitchLeftSideV28,
  selectAppFromLeftSideV28,
...
describe('Native Federated Sharing Functionality for Nextcloud v29 and v28', () => {
   ...
   */
  it('Send a federated share of a file from Nextcloud v29 to Nextcloud v28', () => {
