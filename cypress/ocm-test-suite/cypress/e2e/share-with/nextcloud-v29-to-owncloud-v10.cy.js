/**
 * @fileoverview
 * Cypress test suite for testing native federated sharing functionality in Nextcloud v29 and ownCloud v10.
...
describe('Native Federated Sharing Functionality for Nextcloud to ownCloud', () => {
   ...
   */
  it('Send a federated share of a file from Nextcloud v29 to ownCloud v10', () => {
