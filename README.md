...
| Test Name | Nextcloud v27.1.11 | Nextcloud v28.0.12 | oCIS v5.0.6 | OcmStub v1.0.0 | ownCloud v10.15.0 | Seafile v11.0.5 |
|-----------|--------------------|--------------------|-------------|----------------|-------------------|-----------------|
...
| Sender (R) / Receiver (C) | Nextcloud v27.1.11 with ScienceMesh | oCIS v5.0.6 | ownCloud v10.15.0 with ScienceMesh |
|---------------------------|-------------------------------------|-------------|-----------------------------------|
...
Run a "share-link" test between ownCloud and Nextcloud instances, using versions `v10.15.0` and `v29.0.8`, respectively, in CI mode with Firefox:
