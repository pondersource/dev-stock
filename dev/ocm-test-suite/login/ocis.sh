...
# -----------------------------------------------------------------------------------
# Script to Test OCIS login flow tests.
...
# Usage:
#   ./ocis.sh [EFSS_PLATFORM_VERSION] [SCRIPT_MODE] [BROWSER_PLATFORM]

# Arguments:
#   EFSS_PLATFORM_VERSION : Version of the EFSS platform (default: "v5.0.0").
...
main() {
    ...
    if [ "${SCRIPT_MODE}" = "dev" ]; then
        run_dev "https://ocis1.docker (username: einstein, password: relativity)" ""
    else
