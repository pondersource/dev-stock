...
# -----------------------------------------------------------------------------------
# Script to Test Seafile login flow tests.
...
#   such as Seafile, using Cypress, and Docker containers.
#   It supports both development and CI environments, with optional browser support.

# Usage:
#   ./seafile.sh [EFSS_PLATFORM_VERSION] [SCRIPT_MODE] [BROWSER_PLATFORM]

# Arguments:
#   EFSS_PLATFORM_VERSION : Version of the EFSS platform (default: "v11.0.0").
...
# Example:
#   ./seafile.sh v11.0.0 ci electron
...
# Default versions
DEFAULT_EFSS_1_VERSION="v11.0.0"
