...
# -----------------------------------------------------------------------------------
# Script to Test OCMStub login flow tests.
...
# Usage:
#   ./ocmstub.sh [EFSS_PLATFORM_VERSION] [SCRIPT_MODE] [BROWSER_PLATFORM]
...
main() {
    ...
    if [ "${SCRIPT_MODE}" = "dev" ]; then
        run_dev "https://ocmstub1.docker (username: einstein, password: relativity)"
    else
