...
# -----------------------------------------------------------------------------------
# Script to Test OwnCloud login flow tests.
...
#   such as OwnCloud, using Cypress, and Docker containers.
#   It supports both development and CI environments, with optional browser support.

# Usage:
#   ./owncloud.sh [EFSS_PLATFORM_VERSION] [SCRIPT_MODE] [BROWSER_PLATFORM]

# Arguments:
#   EFSS_PLATFORM_VERSION : Version of the EFSS platform (default: "v10.13.1").
...
# Example:
#   ./owncloud.sh v10.13.1 ci electron
...
# Default versions
DEFAULT_EFSS_1_VERSION="v10.13.1"
