...
# -----------------------------------------------------------------------------------
# Script to Test Nextcloud to ownCloud OCM share-link flow tests.
# Authors:
...
#   such as Nextcloud, ownCloud, using Cypress, and Docker containers.
...
#   EFSS_PLATFORM_2_VERSION : Version of the second EFSS platform (default: "v10.15.0").
...
# Example:
#   ./nextcloud-owncloud.sh v28.0.14 v10.15.0 ci electron
...
main() {
    ...
    sed -i 's/.*modifyObstructiveCode: true,.*/  modifyObstructiveCode: false,/' \
        "${ENV_ROOT}/cypress/ocm-test-suite/cypress.config.js"
