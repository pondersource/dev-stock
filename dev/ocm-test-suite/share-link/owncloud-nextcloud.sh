...
# owncloud version:
#   - v10.15.0
EFSS_PLATFORM_1_VERSION=${1:-"v10.15.0"}
...
# Nextcloud.
createEfss    nextcloud   1    einstein    relativity      nextcloud.sh    "${EFSS_PLATFORM_2_VERSION}"
...
if [ "${SCRIPT_MODE}" = "dev" ]; then
  ...
  docker run --network=testnet                                                  \
    ...
    --spec "cypress/e2e/share-link/owncloud-${P1_VER}-to-nextcloud-${P2_VER}.cy.js"
