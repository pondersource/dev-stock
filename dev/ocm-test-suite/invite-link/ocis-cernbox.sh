...
# Example:
#   ./ocis-cernbox.sh v5.0.9 v1.29.0 ci electron
# -----------------------------------------------------------------------------------
...
main() {
    ...
    prepare_ocis_environment "ocis1.docker,ocis1.docker,dav/" "revacernbox1.docker,cernbox1.docker,remote.php/webdav/"
