...
# Example:
#   ./opencloud-cernbox.sh v2.3.0 v1.29.0 ci electron
# -----------------------------------------------------------------------------------
...
main() {
    ...
    prepare_opencloud_environment "opencloud1.docker,opencloud1.docker,dav/" "revacernbox1.docker,cernbox1.docker,remote.php/webdav/"
