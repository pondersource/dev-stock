...
# Arguments:
#   EFSS_PLATFORM_1_VERSION : Version of the first EFSS platform (default: "v2.0.2").
#   EFSS_PLATFORM_2_VERSION : Version of the second EFSS platform (default: "v2.0.2").
...
# Example:
#   ./opencloud-opencloud.sh v2.0.2 v2.0.2 ci electron
# -----------------------------------------------------------------------------------
...
# Default versions
DEFAULT_EFSS_1_VERSION="v2.0.2"
DEFAULT_EFSS_2_VERSION="v2.0.2"
...
main() {
    ...
    #                # id   # image                      # tag
    create_opencloud 1      opencloudeu/opencloud        "${EFSS_PLATFORM_1_VERSION}"
    create_opencloud 2      opencloudeu/opencloud        "${EFSS_PLATFORM_2_VERSION}"
