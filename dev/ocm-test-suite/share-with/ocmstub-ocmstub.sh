...
# -----------------------------------------------------------------------------------
# Script to Test OcmStub to OcmStub OCM share-with flow tests.
...
main() {
    ...
    if [ "${SCRIPT_MODE}" = "dev" ]; then
        ...
        docker run --network="${DOCKER_NETWORK}" \
            ...
            --spec "cypress/e2e/share-with/ocmstub-${P1_VER}-to-ocmstub-${P2_VER}.cy.js" || error_exit "Cypress tests failed."
